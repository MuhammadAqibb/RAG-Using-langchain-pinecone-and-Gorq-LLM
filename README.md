...
> A conversational AI that answers questions **exclusively from your own documents** — no hallucinations, no outside knowledge, just your data.
...
- Chat history resets when the server restarts (in-memory storage)
- The LLM will only answer from your ingested data — this is by design
